...
var strategy = new BearerStrategy({}, function (token, done) {
  ...
  User.findOne({
    ...
    request.post({
      ...
      userData.nickname = userData.user_metadata.firstName;
      userData.avatar = userData.user_metadata.picture;
      ...
      User.findOrCreate({
        ...
        User.findOne(currentUser.id).then(function(populatedUser) {
